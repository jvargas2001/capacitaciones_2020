...
if __name__ == '__main__':
    ...
    while True:
        ...
        for cnt in contours:
            ...
            if w*h> min_area: # w*h es el area mínima
                #Dibujar rectangulo en el frame original
                cv2.rectangle(obs, (x, y), (x+w, y+h), (180,100,200), 3)
        ...
        img_final=cv2.cvtColor(img_erode, cv2.COLOR_HSV2RGB)
        cv2.imshow('filtrado', cv2.cvtColor(img_final, cv2.COLOR_RGB2BGR))
